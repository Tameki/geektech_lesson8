...
/**
 * The configuration screen for the {@link BaseWidget BaseWidget} AppWidget.
 */
public class BaseWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.geektech.widgetlesson.widgets.BaseWidget";
